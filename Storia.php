	...
	<script type="text/javascript" src="jquery/jquery.min.js"></script>
		...
		?>
			<div id = "sidebar1">
				...
				<br/>
				<a class ="corrente" href="Storia.php"> Storia </a>
				<br/>
			...
			<div id = "content">
				<h2> Storia </h2>
				<p> CIVILTA' NURAGICA </p>
				<p> La più antica e più grande civiltà della Sardegna si è sviluppata dall'età del bronzo fino all'età del ferro , comprendendo un periodo di tempo che va dal 1600 A.C. alla definitiva conquista romana dell'isola. La presenza di tanti nuraghi nelle nostre campagne fa pensare, dunque ad una zona densamente abitata già in quella lontana epoca. Il Casalis nel volume XIII del "Dizionario Geografico" alla voce "Antichità" riferisce quanto segue:
					"Nell'Orunese sono conosciuti undici nuraghi e sono: <br/>
					<ol>
						<li> Il nuraghe di Santa Giulia, così denominato da una cappella prossima ora distrutta; </li>
						<li> Il nuraghe di Nunnale; </li>
						<li> Il nuraghe della Vergine d'Itria o del Prato;</li>
						<li> Il nuraghe di S. Efisio; </li>
						<li> Il nuraghe di Galile; </li>
						<li> Il nuraghe Curtu; </li>
						<li> Il nuraghe Ederosu; </li>
						<li> Il nuraghe di Serra de mesu; </li>
						<li> Sos nuraches; </li>
						<li> Il nuraghe di Istiti; </li>
						<li> Il nuraghe di Ilaila </li>
					</ol>
					...
					La società nuragica era divisa in classi sociali: <br/>
					La Plebe, costituita da agricoltori, pastori, artigiani e piccoli commercianti. <br/>
					I sacerdoti, che svolgevano le pratiche del culto, della medicina e della magia. <br/>
					I nobili, proprietari latifondisti e guerrieri, Classe importante era quella dei guerrieri che dovevano difendere 1'indipendenza dei sardi contro i mercenari cartaginesi e i legionari di Roma. <br/>
					Il capo, il re,o grande patriarca della tribù. <br/>
				...
				<p> DATI STORICI RISALENTI AL 1300 </p>
				<p> Il Villaggio di Oruni, in questo periodo storico, fu compreso: <br/>
					<ul>
						<li> nella Contea del Goceano, </li>
						<li> del Giudicato di Lugudoro, </li>
						<li> nella diocesi di Castra. </li>
					</ul>
